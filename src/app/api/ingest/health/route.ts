...
export async function POST(request: Request) {
  ...
  const record = {
    ...
    // ── Activity ─────────────────────────────────────────────
    steps: num(body.steps, body.stepCount),
    active_calories: num(body.active_calories, body.activeCalories),
    total_calories: num(body.total_calories, body.totalCalories),
    ...
    flights_climbed: num(body.flights_climbed, body.flightsClimbed),
    activity_minutes: num(body.activity_minutes, body.exercise_minutes, body.exerciseTime),
    stand_hours: num(body.stand_hours, body.standHours),
    ...
    // ── Heart ─────────────────────────────────────────────────
    resting_heart_rate: num(body.resting_heart_rate, body.restingHeartRate),
    ...
    // ── Vitals ────────────────────────────────────────────────
    spo2: num(body.spo2, body.oxygenSaturation, body.bloodOxygen),
